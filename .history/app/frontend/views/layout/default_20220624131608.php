...
<body>
    <div class="app">
                                ...
                                <li class="header__nav-menu-item">
                                    ...
                                    <ul class="navbar__shop">
                                        <li class="navbar__shop--item">
                                            <a href="<?= base_url('pet/pet') ?>" class="navbar__shop--link deal-hot arrow-right">Thú cưng</a>
                                            <ul class="navbar__shop--pet">
                                                <li class="navbar__shop--pet-item">
                                                    <a href="#" class="navbar__shop--pet-link deal-best">Chó</a>
                                                </li>
                                                <li class="navbar__shop--pet-item">
                                                    <a href="#" class="navbar__shop--pet-link">Mèo</a>
                                                </li>
                                                <li class="navbar__shop--pet-item">
                                                    <a href="#" class="navbar__shop--pet-link">Chuột hamster</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="navbar__shop--item">
                                            <a href="<?= base_url('product/product') ?>" class="navbar__shop--link arrow-right">Đồ ăn</a>
                                            <ul class="navbar__shop--food">
                                                <li class="navbar__shop--food-item">
                                                    <a href="#" class="navbar__shop--food-link arrow-right">Đồ ăn cho
                                                        chó</a>
                                                    <ul class="navbar__shop-foodDog">
                                                        <li class="navbar__shop-foodDog-item">
                                                            <a href="#" class="navbar__shop-foodDog-link deal-hot">Sữa</a>
                                                        </li>
                                                        <li class="navbar__shop-foodDog-item">
                                                            <a href="#" class="navbar__shop-foodDog-link">Royal
                                                                Canin</a>
                                                        </li>
                                                        <li class="navbar__shop-foodDog-item">
                                                            <a href="#" class="navbar__shop-foodDog-link">Ganador</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="navbar__shop--food-item">
                                    ...
                                    ">Đồ ăn cho mèo</a>
                                                    <ul class="navbar__shop-foodCat">
                                                        <li class="navbar__shop-foodCat-item">
                                                            <a href="#" class="navbar__shop-foodCat-link">Sữa</a>
                                                        </li>
                                                        <li class="navbar__shop-foodCat-item">
                                                            <a href="#" class="navbar__shop-foodCat-link deal-new">Hạt
                                                                khô</a>
                                                        </li>
                                                        <li class="navbar__shop-foodCat-item">
                                                            <a href="#" class="navbar__shop-foodCat-link">Cá</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="navbar__shop--food-item">
                                                    ...
                                                    <ul class="navbar__shop-foodMouse">
                                                        <li class="navbar__shop-foodMouse-item">
                                                            <a href="#" class="navbar__shop-foodMouse-link">Sữa</a>
                                                        </li>
                                                        <li class="navbar__shop-foodMouse-item">
                                                            <a href="#" class="navbar__shop-foodMouse-link">Hạt khô</a>
                                                        </li>
                                                        <li class="navbar__shop-foodMouse-item">
                                                            <a href="#" class="navbar__shop-foodMouse-link deal-hot">Thịt</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="navbar__shop--item">
                                            <a href="#" class="navbar__shop--link arrow-right">Phụ kiện</a>
                                            <ul class="navbar__shop--extra">
                                                <li class="navbar__shop--extra-item">
                                                    <a href="" class="navbar__shop--extra-link deal-best">Đồ chơi</a>
                                                </li>
                                                <li class="navbar__shop--extra-item">
                                                    <a href="" class="navbar__shop--extra-link deal-hot">Áo quần</a>
                                                </li>
                                                <li class="navbar__shop--extra-item">
                                                    <a href="" class="navbar__shop--extra-link">Vật Dụng</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="navbar__shop--item">
                                            <a href="#" class="navbar__shop--link deal-new arrow-right">Dịch vụ</a>
                                            <ul class="navbar__shop--service">
                                                <li class="navbar__shop--service-item">
                                                    <a href="#" class="navbar__shop--service-link deal-new">
                                                        Trông giữ</a>
                                                </li>
                                                <li class="navbar__shop--service-item">
                                                    <a href="#" class="navbar__shop--service-link">Chăm sóc</a>
                                                </li>
                                                <li class="navbar__shop--service-item">
                                                    <a href="#" class="navbar__shop--service-link">Thú y</a>
                                                </li>
                                                <li class="navbar__shop--service-item">
                                                    <a href="#" class="navbar__shop--service-link">Phối giống</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                        ...
                        <div class="header__nav-warp">
                            <div class="header__nav-warp-search">
                                ...
                                <div class="header__nav-warp-search-form">
                                    <form action="# " method="post">
                                        <input type="text" placeholder="Tìm mọi thứ ở đây ..." class="header__nav-warp-search-form--input" />
                            ...
                            <div class="header__nav-warp-login">
                                ...
                                <?php if (!isset($_SESSION['id'])) : ?>
                                    <a href="<?= base_url('login/login') ?>" class="header__nav-warp-link">
                                        <i class="header__nav-warp-icon fas fa-sign-in-alt"></i>
                                    </a>
                                <?php else : ?>
                                    <a href="<?= base_url('user/user') ?>" class="header__nav-warp-link">
                            ...
                            <div class="header__nav-warp-cart">
                                ...
                                <a href="<?= base_url('cart/cart') ?>" class="header__nav-warp-link">
        ...
        <div class="service grid wide">
            ...
            <div class="row">
                ...
                <div class="col l-3 m-6 c-6">
                    <div class="service-item">
                        <img src="<?= load_images('icon', '24-hours.png') ?>" class="service-item__img" />
                        <div class="service-item__content">
                ...
                <div class="col l-3 m-6 c-6">
                    <div class="service-item">
                        <img src="<?= load_images('icon', 'delivery-truck.png') ?>" class="service-item__img" />
                        <div class="service-item__content">
                ...
                <div class="col l-3 m-6 c-6">
                    <div class="service-item">
                        <img src="<?= load_images('icon', 'location.png') ?>" class="service-item__img" />
                        <div class="service-item__content">
                    ...
                    <div class="row">
                            ...
                            "></i>
                                        ...
                                        <li class="footer-top-widget__social-item">
                                            <a href="tel:0984235062" class="footer-top-widget__social-link">
                                                <i class="fas fa-phone footer-top-widget__social-icon"></i>
                            ...
                            <div class="footer-top-useful">
                                ...
                                <ul class="footer-widget-top-content-list">
                                    <li class="footer-widget-top-content-item">
                                        <a href="#" class="footer-widget-top-content-link">Trợ giúp & Liên hệ với chúng
                                            tôi
                                        </a>
                                    </li>
                                    <li class="footer-widget-top-content-item">
                        ...
                        <div class="col l-3 m-6 c-12">
                            <div class="footer-top-help">
                                ...
                                <ul class="footer-widget-top-content-list">
                                    <li class="footer-widget-top-content-item">
                                        <a href="#" class="footer-widget-top-content-link">Câu hỏi thường gặp
                                        </a>
                                    </li>
                                    <li class="footer-widget-top-content-item">
                                        <a href="#" class="footer-widget-top-content-link">
                                ...
                                <div class="footer__input-boxs">
                                    <form action="#" method="post">
                                        <div class="footer__input-box">
                                            ...
                                            <input type="text" class="footer__input" placeholder="Họ và tên" />
                                        </div>
                                        <div class="footer__input-box">
    ...
    <!-- <script type="module" src="<?= load_js('get_products') ?>"></script> -->
