...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?= load_css('grid.css') ?>" />
            ...
            <div class="header-container grid wide" id="header">
                ...
                <div class="col l-8 m-0 c-0">
                    ...
                    <ul class="header__nav-menu__list">
                        ...
                        <a href="" class="header__nav-menu--link">HOME</a>
                        </li>
                        <li class="header__nav-menu-item">
                        <a href="" class="header__nav-menu--link">SHOP</a>
                        <!-- shop none -->
                        ...
                        <li class="header__nav-menu-item">
                        <a href="" class="header__nav-menu--link">PAGES</a>
                        <ul class="navbar__page">
                            <li class="navbar__page--item">
                            <a href="#" class="navbar__page--link">Shop page</a>
                            </li>
                            <li class="navbar__page--item">
                            <a href="#" class="navbar__page--link">Shop list</a>
                            </li>
                            <li class="navbar__page--item">
                            <a href="#" class="navbar__page--link">Wish list</a>
                            </li>
                            <li class="navbar__page--item">
                            <a href="#" class="navbar__page--link">My account</a>
                            </li>
                        </ul>
                        </li>
                        <li class="header__nav-menu-item">
                        ...
                        <li class="header__nav-menu-item">
                        <a href="" class="header__nav-menu--link">CONTACT US</a>
                        </li>
                    </ul>
                    </nav>
                </div>
      ...
      <div class="service grid wide">
        ...
        <div class="row">
            <div class="col l-3 m-6 c-6">
                ...
                <img src="./assets/img/icon/shop.png" class="service-item__img" />
            ...
            <div class="col l-3 m-6 c-6">
                <div class="service-item">
                <img
                    src="./assets/img/icon/24-hours.png"
            ...
            <div class="col l-3 m-6 c-6">
                <div class="service-item">
                <img
                    src="./assets/img/icon/delivery-truck.png"
                    class="service-item__img"
                />
                <div class="service-item__content">
        ...
        <div class="icon__footer-right ">
          <div class="icon__footer-active">
            <a class="icon__footer-action">
              <img src="./assets/img/icon/zalo-icon-2.png" alt="" class="icon__footer-action--img">
            </a>
