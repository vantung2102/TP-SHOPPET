...
<html lang="en">
    <head>
        ...
        <link href="<?= load_css('admin4') ?>" rel="stylesheet">
        <link href="<?= load_css('dark_theme') ?>" rel="stylesheet">
        <link href="<?= load_css('custom') ?>" rel="stylesheet">
    ...
    <body>
        ...
        <script src="<?= load_js('ashboard')?>dashboard.js"></script>
    </body>
</html>