        ...
        <div class="page-sidebar">
            ...
            <div class="page-sidebar-inner slimscroll">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="<?= base_url('admin/order') ?>"><i
                                class="material-icons-outlined">calendar_today</i>ĐƠN
                            HÀNG</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#"><i class="material-icons">text_format</i>PHÔNG CÁNH<i
                    ...
                    <li>
                        <a href=""><i class="material-icons">apps</i>Các thành phần<i
                                class="material-icons has-sub-menu">add</i></a>
                        <ul class="sub-menu">
                            <li>
                    ...
                    <li>
                        <a href=""><i class="material-icons">star_border</i>Trang<i
                                class="material-icons has-sub-menu">add</i></a>
                        <ul class="sub-menu">
                            <li>
