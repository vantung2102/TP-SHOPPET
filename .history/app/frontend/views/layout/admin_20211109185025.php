    ...
    <div class="connect-container align-content-stretch d-flex flex-wrap">
          ...
          <ul class="accordion-menu">
            ...
            <li>
              <a href="<?= base_url('admin/user') ?>"
                ><i class="material-icons-outlined">account_circle</i>TÀI KHOẢN
                KHÁCH</a
              >
            </li>
            <li>
              <a href="<?= base_url('admin/order') ?>"
              ><i class="material-icons-outlined">calendar_today</i>ĐƠN
              HÀNG</a
              >
            </li>
            <li>
            ...
            <li>
              <a href="#"
                ><i class="material-icons">text_format</i>PHÔNG CÁNH<i
      ...
      <div class="page-container">
        ...
        <?php
          ...
          {
            header('Location:http://localhost/TP&SHOPPET/?module=admin&action=login');
            die();
          }
        ?>
