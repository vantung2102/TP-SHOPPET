...
<html lang="en">
    <head>
        ...
        <link href="<?= load_css('admin4') ?>../../assets/css/admin4.css" rel="stylesheet">
        <link href="<?= load_css('dark_theme') ?>../../assets/css/dark_theme.css" rel="stylesheet">
        <link href="<?= load_css('custom') ?>../../assets/css/custom.css" rel="stylesheet">
