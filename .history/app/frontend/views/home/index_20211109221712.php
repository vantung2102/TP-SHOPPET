    ...
    <div class="products">
        <div class="product grid wide">
            ...
            <div class="col l-2 m-2 c-12">
                ...
                <img class="product__img-pet" src="<?= load_images('icon','corgi.png') ?>" alt="icon">
                <h3>Thú cưng</h3>
                </div>
            </div>
            <div class="col l-10 m-10 c-12">
                ...
                <div class="row sm-gutter">
                    ...
                    <div class="product-wrapper">
                        ...
                        <a href="#">
                            <img src="<?= load_images('pet', 'BichconFrise.jpg') ?>" alt="hinh">
                        </a>
            ...
            <a href="<?= base_url('product/product') ?>" class="product__select-pet hidden-mobile">
                <h4>See more</h4>
            ...
            <div class="col l-2 m-2 c-12">
                ...
                <img class="product__img-pet" src="<?= load_images('icon','pet-food.png') ?>" alt="icon">
                <h3>Mục khác</h3>
                </div>
            </div>
            ...
            <a class="product__select-noPet  hidden-mobile">
                <h4>See more</h4>
                <i class="product__select-icon fas fa-angle-double-right"></i>
            </a>
            </div>
        ...
        <div class="grid">
            <div class="review__container">
                ...
                <div class="review__text center">
                    <h2>TOP REVIEW</h2>
                    <p>Nuôi thú cưng là một trong những sở thích được yêu thích nhất hiện nay, đặc biệt là những quốc gia châu âu. Tuy nhiên không phổ biến ở Việt Nam, vì vậy hay lang tỏa tình yêu động vật đến moị người</p>
                </div>
                <div class="row review__users">
                    <div class="col l-4 m-6 c-12">
                        <div class="user-info">
                            <div class="user-info__avatar">
                                <img src="<?= load_images('pet', 'Chó Phốc sóc.jpg') ?>" alt="hinh">
                            </div>
                            <div class="user-info__content">
                                <h4 class="user-info__content-name">Tô thị thanh tâm</h4>
                                <p class="user-info__content-comment">tôi rất yêu thích loài chó, tôi rất yêu thích loài chó tôi rất yêu thích loài chó</p>
