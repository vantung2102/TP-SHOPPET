      ...
      <div class="select-input">
        ...
        <ul class="select-input__list">
          <li class="select-input-item">
            <a href="<?= base_url('pet/processSortAsc') ?>" class="select-input__link">Giá : Thấp đến cao</a>
          </li>
          <li class="select-input-item">
            <a href="<?= base_url('pet/processSortDesc') ?>" class="select-input__link">Giá : Cao đến thấp</a>
          </li>
        </ul>
            ...
            <!-- pagination-item-active -->
              ...
              <?php if(isset($_GET['processSortAsc'])): ?>
                ...
                <?php for ($i = 2; $i <= $data['total_pages']; $i++): ?>
                  <li class="product__pagination-item ">
                    <a href="<?= base_url("pet/pet&processSortAsc&page=$i") ?>" class="product__pagination-link"><?= $i ?></a>
                  </li>
                <?php endfor; ?>
              <?php elseif(isset($_GET['processSortDesc'])):?>
                <li class="product__pagination-item pagination-item-active">
                  <a href="<?= base_url("pet/pet&processSortDesc&page=1") ?>" class="product__pagination-link">1</a>
                </li>
                <?php for ($i = 2; $i <= $data['total_pages']; $i++): ?>
                  <li class="product__pagination-item ">
