      ...
      <div class="select-input">
        ...
        <ul class="select-input__list">
          <li class="select-input-item">
            <a href="<?= base_url('home/processSort') ?>" class="select-input__link" value="1">Giá : Thấp đến cao</a>
          </li>
          <li class="select-input-item">
            <a href="<?= base_url('home/processSort') ?>" class="select-input__link" value="2">Giá : Cao đến thấp</a>
          </li>
        </ul>
      </div>
    </div>
