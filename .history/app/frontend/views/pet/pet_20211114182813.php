      ...
      <div class="select-input">
        ...
        <ul class="select-input__list">
          <li class="select-input-item">
            <a href="<?= base_url('home/processSort') ?>" class="select-input__link" value="1" name="des">Giá : Thấp đến cao</a>
          </li>
          <li class="select-input-item">
            <a href="<?= base_url('home/processSort') ?>" class="select-input__link" value="2" name="aes">Giá : Cao đến thấp</a>
          </li>
        </ul>
      </div>
    </div>
