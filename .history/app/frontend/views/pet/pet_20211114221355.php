      ...
      <div class="select-input">
        ...
        <ul class="select-input__list">
          <li class="select-input-item">
            <a href="<?= base_url('pet/processSortDesc') ?>" class="select-input__link" value="1" name="des" onchange="this.form.submit()">Giá : Thấp đến cao</a>
          </li>
          <li class="select-input-item">
            <a href="<?= base_url('pet/processSortDesc') ?>" class="select-input__link" value="2" name="aes" onchange="this.form.submit()">Giá : Cao đến thấp</a>
          </li>
        </ul>
