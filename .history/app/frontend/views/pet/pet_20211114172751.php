      ...
      <div class="select-input">
        ...
        <ul class="select-input__list">
          <li class="select-input-item">
            <a href="<?= base_url('home/processSort') ?>" class="select-input__link">Giá : Thấp đến cao</a>
          </li>
          <li class="select-input-item">
            <a href="<?= base_url('home/processSort') ?>" class="select-input__link">Giá : Cao đến thấp</a>
          </li>
        </ul>
      </div>
    </div>
