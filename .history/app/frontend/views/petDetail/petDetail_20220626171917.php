                        ...
                        <div class="product-detail__illustration">
                            <div class="product-detail__illustration-img">
                                ...
                                <div class="product-detail__illustration-img-show">
                                    <img src="<?= load_images('pet', $data['img']) ?>" class="product-detail__illustration-img-item" onclick="changeImage('one')" id="one" />

                                    <img src="<?= load_images('pet', $data['img']) ?>" class="product-detail__illustration-img-item" onclick="changeImage('two')" id="two" />

                                    <img src="<?= load_images('pet', $data['img']) ?>" class="product-detail__illustration-img-item" onclick="changeImage('three')" id="three" />

                                    <img src="<?= load_images('pet', $data['img']) ?>" class="product-detail__illustration-img-item" onclick="changeImage('four')" id="four" />
                                </div>
                            </div>
                        </div>
                        ...
                        "></i>
                                ...
                                <div class="product-detail__infor-select">
                                    <div class="product-detail__infor-select-price">
                                        <div class="product-detail__infor-select-price-old price-old" data-old_price="<?= $data['old_price'] ?>">
                                            <?= $data['old_price'] ?>
                                        </div>
                                        <div class="product-detail__infor-select-price-new price-new" data-new_price="<?= $data['new_price'] ?>">
                                            <?= $data['new_price'] ?>
                                        </div>
                                    </div>
