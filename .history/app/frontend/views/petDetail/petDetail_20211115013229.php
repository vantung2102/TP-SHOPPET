            ...
            <div class="product-detail__infor">
              <div class="product-detail__infor-title">
                <div class="product-detail__infor-title-name">
                  <h1 class="name_<?= $data['id']?>"><?= $data['name'] ?></h1>
                </div>
                ...
                <div class="product-detail__infor-select">
                  <div class="product-detail__infor-select-price">
                    <div class="product-detail__infor-select-price-old price-old-<?= $data['id']?>">
                      <?= $data['old_price'] ?>
                    </div>
                    <div class="product-detail__infor-select-price-new price-new-<?= $data['id']?>">
                      <?= $data['new_price'] ?>
                    </div>
                  </div>
