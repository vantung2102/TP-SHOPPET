                ...
                <div class="col l-5 m-5 c-12">
                    <div class="product-detail__illustration">
                        <div class="product-detail__illustration-img">
                            <img src="<?= load_images('pet', $data['img']) ?>"
                                class="product-detail__illustration-img-main data-img" id="img-main"
                                data-img="<?= $data['img'] ?>" />
                            <div class="product-detail__illustration-img-show">
                                <img src="<?= load_images('pet', $data['img']) ?>"
                                    class="product-detail__illustration-img-item" onclick="changeImage('one')"
                                    id="one" />

                                <img src="<?= load_images('pet', $data['img']) ?>"
                                    class="product-detail__illustration-img-item" onclick="changeImage('two')"
                                    id="two" />

                                <img src="<?= load_images('pet', $data['img']) ?>"
                                    class="product-detail__illustration-img-item" onclick="changeImage('three')"
                                    id="three" />

                                <img src="<?= load_images('pet', $data['img']) ?>"
                                    class="product-detail__illustration-img-item" onclick="changeImage('four')"
                                    id="four" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="product-detail__illustration-share">
                        <div class="product-detail__illustration-share-link">
                            ...
                            <div class="product-detail__illustration-share-link-internet">
                                <a class="product-detail__illustration-share-link-item" type="button" role="button"
                    ...
                    <div class="product-detail__infor">
                        <div class="product-detail__infor-title">
                            <div class="product-detail__infor-title-name">
                                <h1 class="name" data-name="<?= $data['name'] ?>"><?= $data['name'] ?></h1>
                            </div>
                        ...
                        "></i>
                            ...
                            <div class="product-detail__infor-select">
                                <div class="product-detail__infor-select-price">
                                    <div class="product-detail__infor-select-price-old price-old"
                                        data-old_price="<?= $data['old_price'] ?>">
                                        <?= $data['old_price'] ?>
                                    </div>
                                    <div class="product-detail__infor-select-price-new price-new"
                                        data-new_price="<?= $data['new_price'] ?>">
                                        <?= $data['new_price'] ?>
                                    </div>
                                </div>
                          ...
                          btn-select-amount
                        ">
                                            <input class="btn-minus-product" type="button" onclick="minus()"
                                                value="-" />
                                ...
                                <div class="product-detail__infor-select-cart">
                                    <button class="bag-btn cart" data-id="<?= $data['id'] ?>">
