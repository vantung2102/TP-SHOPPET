                                ...
                                <form action="<?= base_url('user/changeInfo') ?>" id="form_personal-infor"
                                    ...
                                    <div class="information_input">
                                        ...
                                        <div id="information_input-sex">
                                            ...
                                            <input type="radio" name="gender" value="khác" id="another"
                                                class="information_input-sex--item" />
                        ...
                        <div class="user-password-cotain">
                            <form action="<?= base_url('user/changePassword') ?>" method="post" id="form_password">
                                <div class="password_input">
                                    ...
                                    <input type="password" name="old_pass" id="pass" placeholder="Nhập mật khẩu"
                                        class="input-pass" />
                                    ...
                                    <input type="password" name="renew_pass" id="pass"
                                        placeholder="Nhập xác nhận mật khẩu" class="input-pass" />
                                </div>
                                <div class="btn_save-change">
                                    <button type="submit">Lưu thay đổi</button>
                                </div>
