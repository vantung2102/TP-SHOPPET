...
<div class="product-cart">
  <div class="grid wide show_cart">
    ...
    <form action="<?= base_url('cart/processPay')?>" method="post">
          ...
          <div class="col l-12">
            <div class="product-cart__total--pay">
              <div class="product-cart__total--price">
                ...
                <div class="product-cart__total--money"><sup>đ</sup>0</div>
              </div>
              <button type="submit" class="product-cart__buy">Mua hàng</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="product-cart-mobile_description m-11 c-11">
        <div class="product-cart-mobile__image">
          <!--<input type="checkbox" class="product-cart-mobile_checkbox">-->
          <img
            src="./assets/img/Phocsoc.jpg"
            alt=""
        ...
        <div class="product-cart-mobile__specific">
          ...
          <div class="product-cart-mobile__amount">
            <input
              class="btn-minus--amount__mobile"
              type="button"
              onclick="minus_mobile()"
              value="-"
            />
            <input
              id="amount_mobile"
              class="input--amount__mobile"
              type="text"
              value="1"
            />
            <input
              class="btn-plus--amount__mobile"
              type="button"
              onclick="plus_mobile()"
              value="+"
            />
      ...
      <div class="product-cart-mobile__pay m-12 c-12">
        <div class="product-cart__mobile-total">
          <div class="product-cart__mobile-total--money">
            ...
            <div class="product-cart__mobile-money">đ0</div>
          </div>
