                                        ...
                                        <div class="card-body">
                                            <form action="<?= base_url('admin/processAll') ?>" method="post">
                                                <div class="row">
                                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"
                                                                placeholder="Mã thú cưng" name="id_pet" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                                        <div class="input-group">
                                                    ...
                                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" placeholder="Giống"
                                                                name="specie" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 col-md-4 col-sm-6">
                              ...
                              >
                                <i class="fa fa-eye"></i>
                                                        ...
                                                        <a href="<?= base_url("admin/delete&id_pet=$id") ?>">
                                                            <button type="button"
                                                                class="btn btn-icon btn-sm js-sweetalert" title="Delete"
                                                                data-type="confirm">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col">
                                            <div class="card">
                                                ...
                                                <form action="<?= base_url("admin/processUpload") ?>" class="card-body"
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Số lượng <span
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input data-provide="datepicker" data-date-autoclose="true"
                                                                class="form-control" name="specie" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
