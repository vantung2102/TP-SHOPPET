                      ...
                      <form action="" method="post">
                        <div class="card">
                          ...
                          <div class="table-responsive">
                            <table
                              class="table table-striped table-vcenter mb-0"
                            >
                              <tbody>
                                <tr>
                                  <td class="tx-medium">Số Lượng</td>
                                  <td class="tx-medium">Màu</td>
                                  <td class="tx-medium">Giới tính</td>
                                </tr>
                                <tr>
                                  <td class="tx-medium">2</td>
                                  <td class="tx-medium">Trắng</td>
                                  <td class="tx-medium">Đực</td>
                                </tr>
                                <tr>
                                  <td class="tx-medium">Giống</td>
                                  <td class="tx-medium">Tuổi</td>
                                  <td class="tx-medium">Đánh giá</td>
                                </tr>
                                <tr>
                                  <td class="tx-medium">Canada</td>
                                  <td class="tx-medium">3</td>
                                  <td class="tx-medium">4.8</td>
                                </tr>
                                <tr>
                                  <td class="tx-medium">Giá Cũ</td>
                                  <td class="tx-medium">Giá Mới</td>
                                  <td class="tx-medium">
                                    <button type="submit" style="background-color:none !important">Xóa</button>
                                  </td>
                                </tr>
                                <tr>
                                  <td class="tx-medium">12000</td>
                                  <td class="tx-medium">13000</td>
                                  <td class="tx-medium">
