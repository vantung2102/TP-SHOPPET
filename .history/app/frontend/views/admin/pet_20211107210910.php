                      ...
                      <div class="card">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped table-vcenter mb-0">
                            <tbody>
                              <tr>
                                <td class="tx-medium">Giá cũ: 1200000</td>
                                <td class="text-right">Giá mới: 130000</td>
                                <td class="text-right">Giống: canada</td>
                              </tr>
                              <tr>
                                <td class="tx-medium">Màu: Trắng</td>
                                <td class="text-right">Giới Tính: đực</td>
                                <td class="text-right">Số lượng: 2</td>
