                        ...
                        <div class="container-fluid">
                            <div class="d-flex justify-content-between align-items-center">
                                <ul class="nav nav-tabs page-header-tab">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#Student-all">Danh sách thú
                                            cưng</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#Student-add">Thêm thú cưng</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="container-fluid">
                            <div class="tab-content">
                                <div class="tab-pane active" id="Student-all">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="<?= base_url('admin/processAll') ?>" method="post">
                                                <div class="row">
                                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" placeholder="Mã thú cưng" name="id_pet" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                                        <div class="input-group">
                                                    ...
                                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" placeholder="Giống" name="specie" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                                        <select class="form-control input-height" name="price">
                                                    ...
                                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                                        <select class="form-control input-height" name="age">
                                            ...
                                            <?php foreach ($data['pets'] as $data) : $id = $data['id']; ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<?= load_images('pet', $data['img']) ?>" class="product-detail__illustration-img-main data-img" id="img-main" data-img="<?= $data['img'] ?>" />
                                                        </td>
                                                        <td><?= $data['count'] ?></td>
                                                        <td><?= $data['color'] ?></td>
                                                        <td><?= $data['sex'] ?></td>
                                            ...
                                            <div class="card">
                                                ...
                                                <form action="<?= base_url("admin/processUpload") ?>" class="card-body" method="post" enctype="multipart/form-data">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Tên thú cưng
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Mã thú cưng
                                                            <span class="text-danger">*</span></label>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" name="id_pet" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Tuổi
                                                            <span class="text-danger">*</span></label>
                                                        <div class="col-md-9">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Số lượng <span class="text-danger">*</span></label>
                                                        <div class="col-md-9">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Loại
                                                            <span class="text-danger">*</span></label>
                                                        <div class="col-md-9">
                                                            <input data-provide="datepicker" data-date-autoclose="true" class="form-control" name="specie" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Giá cũ
                                                            <span class="text-danger">*</span></label>
                                                        <div class="col-md-9">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Giá mới
                                                            <span class="text-danger">*</span></label>
                                                        <div class="col-md-9">
