...
<div class="products__container">
  <div class="grid wide">
    ...
    <div class="home-filter">
      ...
      <!-- <div class="home-filter__page">
        <span class="home-filter__page-number">
          <span class="home-filter__page-current">1</span>/20
        </span>
    ...
    <!--Product-->
    <div class="products__container-title-text">CHÓ CẢNH</div>
    <div class="row">
      <div class="col l-3 m-6 c-12">
        <div class="category-products-item">
          ...
          <div class="category-products-item__action">
            <div class="category-products-item__star">
          ...
          <div class="category-products-item__sale">
            <span class="category-products-item__sale-percent">10%</span>
            <span class="category-products-item__sale-label">GIẢM</span>
          </div>
        </div>
      </div>
      <div class="col l-3 m-6 c-12">
