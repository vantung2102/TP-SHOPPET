...
<div class="products__container">
  <div class="grid wide">
    ...
    <div class="grid wide">
      ...
      <?php foreach($data['product'] as $key): $id = $key['id']?>
        ...
        <div class="col l-3 m-6 c-12">
          <div class="category-products-item">
            <div
              ...
              style="
                background-image: url(<?= load_images('product', $key['img']) ?>);
              "
            ></div>
            ...
            <div class="category-products-item__action">
              ...
              <a href="<?= base_url("productDetail/productDetail&id_product=$id") ?>" class="category-products-item__detail">Chi tiết</a>
            </div>
