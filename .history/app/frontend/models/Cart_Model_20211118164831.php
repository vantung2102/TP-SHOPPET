<?php
    class Cart_Model extends Base_Model{
        ...
        function insertCarts($data = '') {
            ...
            $query_2 = "insert into {$this->table_orderDetail} (order_id, pet_id, Product_id, num, total_money)
                        value(:order_id, :pet_id, :Product_id, :num, :total_money)";
