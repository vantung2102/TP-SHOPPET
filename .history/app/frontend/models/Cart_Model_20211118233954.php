    ...
    class Cart_Model extends Base_Model{
        ...
        function insertOrderDetail($carts, $order_id){
            ...
            foreach ($carts as $data ) {
                $query = "Insert into {$this->table_orderDetail}(order_id, pet_id, product_id, num, price, total_money) values($order_id_2, $data->id, 1, $data->number, $data->price_new, $data->number*$data->price_new)";
                echo $query;
                exit;
            }
        }
