<?php
    ...
    class Admin_Model extends Base_Model{
        ...
        public function processUpload($data){
            ...
            $query = "insert into {$this->table_pet} (id_pet, name, age, count, specie, img, sex, description, color, old_price, new_price) 
            values (:id_pet, :name, :age, :specie, :img, :count, :specie, :img, :sex, :description, :color, :old_price, :new_price)";
