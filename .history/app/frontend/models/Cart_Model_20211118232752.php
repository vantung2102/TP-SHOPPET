    ...
    class Cart_Model extends Base_Model{
        ...
        function insertOrderDetail($carts, $order_id){
            foreach ($carts as $data ) {
                $query = "Insert into {$this->table_orderDetail}(order_id, pet_id, product_id, num, price, total_money) values (int)$order_id, $data->id, 0, $data->number, $data->price, $data->number*$data->price)";
            }
        }
    }
