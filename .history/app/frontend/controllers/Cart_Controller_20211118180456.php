     ...
     class Cart_Controller extends Base_Controller{
        ...
        function get_product_ajax() {
            ...
            if (empty($data)) {
                ...
                $this->model->cart->insertOrders($data);
                $this->model->cart->insertOrderDetail($data);
                // insert db: order: user_id, orderDetail
                // order_details: pet_id,money, ...
            }
