...
<div class="products">
    <div class="product grid wide">
        ...
        <div class="row product__menu-pet">
                            ...
                            <div class="product-item col l-3 m-4 c-12">
                                <div class="product-wrapper">
                                    <div class="product-img">
                                        <a href="<?= base_url("petDetail/petDetail?id_pet=$id") ?>">
            ...
            <a href="<?= base_url('pet/pet') ?>" class="product__select-pet hidden-mobile">
                <h4>xem thêm</h4>
                    ...
                    <div class="row sm-gutter">
                        <?php foreach ($data['product'] as $product) : $id_product = $product['id']; ?>
                            <div class="product-item col l-3 m-4 c-12">
                                <div class="product-wrapper">
                                    <div class="product-img">
                                        <a href="<?= base_url("productDetail/productDetail?id_product=$id_product") ?>">
                                            <div class="product-img-container" style="
        ...
        <div class="review__container">
            ...
            <div class="row review__users">
                <div class="col l-4 m-6 c-12">
                    <div class="user-info">
                        <div class="user-info__avatar">
                            <img src="<?= load_images('icon', 'user1.jpg') ?>" alt="hinh" />
                        </div>
                ...
                <div class="col l-4 m-6 c-12">
                    <div class="user-info">
                        <div class="user-info__avatar">
                            <img src="<?= load_images('icon', 'user2.jpg') ?>" alt="hinh" />
                        </div>
                        <div class="user-info__content">
                ...
                <div class="col l-4 m-6 c-12">
                    <div class="user-info">
                        <div class="user-info__avatar">
                            <img src="<?= load_images('icon', 'user3.jpg') ?>" alt="hinh" />
                        </div>
                        <div class="user-info__content">
                            <h4 class="user-info__content-name">Lê Văn Tùng</h4>
                            <p class="user-info__content-comment">
                                Shop giao hàng nhanh, mới đặt hôm 11/11, 13/11 đã nhận được. Mấy thứ này cún nhà mình
                                rất thích, sẽ quay lại mua lần nữa
                            </p>
                            <div class="product-rate">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
