                                ...
                                <li class="header__nav-menu-item">
                                    ...
                                    <ul class="navbar__shop">
                                        <li class="navbar__shop--item">
                                            <a href="<?= base_url('pet/pet') ?>"
                                                class="navbar__shop--link deal-hot arrow-right">Thú cưng</a>
                                        ...
                                        <li class="navbar__shop--item">
                                            <a href="<?= base_url('product/product') ?>"
                                                class="navbar__shop--link arrow-right">Đồ ăn</a>
                                                ...
                                                <li class="navbar__shop--food-item">
                                                    ...
                                                    <ul class="navbar__shop-foodDog">
                                                        <li class="navbar__shop-foodDog-item">
                                                            <a href="#"
                                                                class="navbar__shop-foodDog-link deal-hot">Sữa</a>
                                                        </li>
                                                        <li class="navbar__shop-foodDog-item">
                                    ...
                                    ">Đồ ăn cho mèo</a>
                                                ...
                                                <li class="navbar__shop--food-item">
                                                    ...
                                                    <ul class="navbar__shop-foodMouse">
                                                        ...
                                                        <li class="navbar__shop-foodMouse-item">
                                                            <a href="#"
                                                                class="navbar__shop-foodMouse-link deal-hot">Thịt</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                ...
                                <div class="footer-top-widget__social">
                                    <ul class="footer-top-widget__social-list">
                                        <li class="footer-top-widget__social-item">
                                            <a href="mailto:TP&Shoppet@gmail.com"
                                                class="footer-top-widget__social-link">
                                                <i class="
                              fas
                              fa-envelope
            ...
            <div class="icon__footer-right ">
                <div class="icon__footer-active">
                    <a class="icon__footer-action">
                        <img class="icon__footer-action--img" src="<?= load_images('icon', 'zalo-icon-2.png') ?>"
                            alt="hinh">
                    </a>
