        ...
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <form action="<?= base_url('admin/processLogin') ?>" method="post">
                                ...
                                <button type="submit" class="btn btn-primary btn-block btn-submit" style="width: 100%">
                                    Đăng nhập
                                </button>
            ...
            <div class="col-lg-6 d-none d-lg-block d-xl-block">
                <div class="auth-image">
                    <svg id="ad3acef6-40f9-4409-a616-f2253c54cee5" data-name="Layer 1"
                        xmlns="http://www.w3.org/2000/svg" width="910.22541" height="801.7228"
                        ...
                        <path
                            ...
                            transform="translate(-144.8873 -49.1386)" fill="#f2f2f2" />
                        <ellipse cx="455" cy="730.7228" rx="455" ry="23" fill="#3f3d56" />
                        <ellipse cx="732.18193" cy="768.7228" rx="178.04348" ry="9" fill="#3f3d56" />
                        <ellipse cx="396.05573" cy="792.7228" rx="178.04348" ry="9" fill="#3f3d56" />
                        <path d="M826.2655,399.3038s30.24614-.44137,23.80221,8.65362-31.44446,8.45972-31.44446,8.45972Z"
                            transform="translate(-144.8873 -49.1386)" fill="#ffb9b9" />
                        <path
                            ...
                            transform="translate(-144.8873 -49.1386)" fill="#7168fc" />
                        <path
                            d="M733.228,287.14939l30.60963,41.55779,26.46415,31.61723s27.42027,28.603,30.47831,32.55875,12.0425,2.82459,10.13026,8.85313-4.766,16.07125-7.7511,17.11492-17.01278-.75185-18.04186-2.737-66.57662-39.03273-89.96813-65.69426l-22.262-15.11-.33393-25.56466Z"
                            transform="translate(-144.8873 -49.1386)" fill="#ff6584" />
                        <path
                            d="M733.228,287.14939l30.60963,41.55779,26.46415,31.61723s27.42027,28.603,30.47831,32.55875,12.0425,2.82459,10.13026,8.85313-4.766,16.07125-7.7511,17.11492-17.01278-.75185-18.04186-2.737-66.57662-39.03273-89.96813-65.69426l-22.262-15.11-.33393-25.56466Z"
                            transform="translate(-144.8873 -49.1386)" opacity="0.1" />
                        <path
                            ...
                            transform="translate(-144.8873 -49.1386)" fill="#2f2e41" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-144.8873 -49.1386)" fill="#2f2e41" />
                        <path d="M547.49616,449.3614s-30.24936,0-23.67342,9,31.56456,8,31.56456,8Z"
                            transform="translate(-144.8873 -49.1386)" fill="#ffb9b9" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-144.8873 -49.1386)" fill="#2f2e41" />
                        <path d="M736.68257,277.72205" transform="translate(-144.8873 -49.1386)" fill="#2f2e41" />
                        <path
