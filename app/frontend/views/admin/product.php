                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2 col-md-4 col-sm-6">
                                                    <a href="javascript:void(0);"
                                                        class="btn btn-sm btn-primary btn-block" title="">Tìm kiếm</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col">
                                            <div class="card">
                                                <form class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Giá cũ <span
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Giá mới <span
                                                                class="text-danger">*</span></label>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" />
                                                        </div>
