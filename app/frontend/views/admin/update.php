                                    ...
                                    <div class="row clearfix">
                                        <div class="col">
                                            <div class="card">
                                                ...
                                                <form action="<?= base_url("admin/processUpdate?id_pet=$id") ?>"
                                                    class="card-body" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input data-provide="datepicker" data-date-autoclose="true"
                                                                class="form-control" value="<?= $data['specie'] ?>"
                                                                name="specie" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control"
                                                                value="<?= $data['old_price'] ?>" name="old_price" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control"
                                                                value="<?= $data['new_price'] ?>" name="new_price" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
